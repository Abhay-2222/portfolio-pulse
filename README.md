...
3. Open a project — health, why it is that number, then **Urgent** moves.
...
Lists filter to attention. Missing inputs show **—**, never a fake 0. No login. Cost rates stay hidden in briefing copy.
